if(GIT_FOUND)
    execute_process(
            ...
            OUTPUT_VARIABLE uvgv3crtp_GIT_HASH
            OUTPUT_STRIP_TRAILING_WHITESPACE
    )
    if(result)
        message(STATUS "Failed to get git hash")
    else()
        message(STATUS "Got git hash: ${uvgv3crtp_GIT_HASH}")
    endif()
endif()

if(uvgrtp_GIT_HASH)
    SET(uvgv3crtp_GIT_HASH "${uvgv3crtp_GIT_HASH}")
endif()

if(UVGRTP_RELEASE_COMMIT)
    set (LIBRARY_VERSION ${PROJECT_VERSION})
elseif(uvgrtp_GIT_HASH)
    set (LIBRARY_VERSION ${PROJECT_VERSION} + "-" + ${uvgv3crtp_GIT_HASH})
else()
...
if (UVGV3CRTP_RELEASE_COMMIT)
    target_compile_definitions(${PROJECT_NAME}_version PRIVATE UVGV3CRTP_RELEASE_COMMIT)
endif()