  ...
  public:
    ...
    */
    struct bitstream_info {
      ...
      std::map<V3C::V3C_UNIT_TYPE, uint8_t> nal_sample_stream_precision = {};
      bool variable_nal_precision = false;
      uint64_t num_GOF = 0;
      std::map<V3C::V3C_UNIT_TYPE, uint64_t> num_nal = {};
...
*/
  ...
  template <>
  uint64_t V3C::get_v3c_unit_size< V3C::V3C_VPS>(const V3C::v3c_unit_info &info);
  template <>
  uint64_t V3C::get_v3c_unit_size< V3C::V3C_AD>(const V3C::v3c_unit_info &info);
  template <>
  uint64_t V3C::get_v3c_unit_size< V3C::V3C_OVD>(const V3C::v3c_unit_info &info);
  template <>
  uint64_t V3C::get_v3c_unit_size< V3C::V3C_GVD>(const V3C::v3c_unit_info &info);
  template <>
  uint64_t V3C::get_v3c_unit_size< V3C::V3C_AVD>(const V3C::v3c_unit_info &info);
}