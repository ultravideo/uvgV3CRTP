...
namespace v3cRTPLib {
  ...
  void V3C::write_out_bitstream_info(bitstream_info & info, std::ostream & out_stream, INFO_FMT fmt)
  {
    switch (fmt)
    {
  ...
  uint64_t V3C::combineBytes(const uint8_t *const bytes, const uint8_t num_bytes) {
  ...
  bool V3C::mmap_v3c_file(char* cbuf, uint64_t len, v3c_file_map &mmap, bitstream_info& info)
  {
    uint64_t ptr = 0;
  ...
  void V3C::parse_v3c_header(v3c_unit_header &hdr, char* buf, uint64_t ptr)
  {
  ...
  uint64_t V3C::get_size(std::string filename)
  {
  ...
  std::unique_ptr<char[]> V3C::get_cmem(std::string filename)
  {
    std::ifstream infile(filename, std::ios_base::binary);
  ...
  V3C::v3c_streams V3C::init_v3c_streams(uvgrtp::session* sess, uint16_t src_port, uint16_t dst_port, int flags, bool rec)
  {
  ...
  V3C::v3c_file_map V3C::init_mmap(uint8_t atlas_nal_precision, uint8_t video_nal_precision)
  {
    v3c_file_map mmap = {};
  ...
  void V3C::create_v3c_unit(v3c_unit_info& current_unit, char* buf, uint64_t& ptr, uint8_t v3c_precision)
  {
  ...
  uint64_t V3C::reconstruct_v3c_gof(bool hdr_byte, char* &buf, uint64_t& ptr, v3c_file_map& mmap, uint64_t index, uint8_t v3c_precision)
  {
  ...
  bool V3C::is_gof_ready(uint64_t index, v3c_file_map& mmap)
  {
  ...
  void V3C::finalize_gof(v3c_file_map& mmap)
  {
  ...
  uint64_t V3C::get_gof_size(bool hdr_byte, uint64_t index, v3c_file_map& mmap, uint8_t v3c_precision)
  {
  ...
  template <V3C::V3C_UNIT_TYPE E>
  uint64_t V3C::get_v3c_unit_size(const v3c_unit_info &info)
  {
  ...
  template <>
  uint64_t V3C::get_v3c_unit_size<V3C::V3C_VPS>(const v3c_unit_info &info)
  {
    return                                                +info.nal_infos.at(0).size; // incl. header
  }
  template <>
  uint64_t V3C::get_v3c_unit_size<V3C::V3C_AD>(const v3c_unit_info &info)
  {
  ...
  template <>
  uint64_t V3C::get_v3c_unit_size<V3C::V3C_OVD>(const v3c_unit_info &info)
  {
    return V3C_HDR_LEN + info.ptr + info.nal_infos.size() * info.sample_stream_nal_precision;
  }

  template <>
  uint64_t V3C::get_v3c_unit_size<V3C::V3C_GVD>(const v3c_unit_info &info)
  {
    return V3C_HDR_LEN + info.ptr + info.nal_infos.size() * info.sample_stream_nal_precision;
  }

  template <>
  uint64_t V3C::get_v3c_unit_size<V3C::V3C_AVD>(const v3c_unit_info &info)
  {
    return V3C_HDR_LEN + info.ptr + info.nal_infos.size() * info.sample_stream_nal_precision;
  }

  uint64_t V3C::get_v3c_unit_size(const V3C::v3c_unit_info &info, const uint8_t unit_type)
  {
    switch (unit_type)
    {
    case V3C_VPS:
